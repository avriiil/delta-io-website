...
This took more than 28seconds on an M1 Macbook Pro with 8 cores. That’s quite slow for a single upsert operation.
...
- **Optimize Table Performance**: Periodically optimize and vacuum yourDelta tables to improve performance and reduce storage costs. Read more in the [Delta Lake Optimize post](https://delta.io/blog/delta-lake-optimize/).
